                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="mobile" class="form-control" id="yourEmail" placeholder="Enter Your Email" required>
                    ...
                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Referral Code</label>
                      <input type="referral" name="referral" class="form-control" id="yourPassword" placeholder="Enter Your Referral Code">
