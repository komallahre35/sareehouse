...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous" />
  ...
  <title>Saree House - Admin Bootstrap Template</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" id='login' action='login.php' novalidate action="" method="post">
  ...
  function Login()
{
    ...
    if(!$this->CheckLoginInDB($admin_username,$admin_password))
    {
        return false;
    }
    ...
    $_SESSION[$this->GetLoginSessionVar()] = $admin_username;
  ...
  $.post("",
    ...
    function(data, status) {
      ...
      if (data == 'Valid') {
        ...
        window.open("http://localhost/niceadmin/admin/login.php?email=" + admin_username + "", "_parent");
