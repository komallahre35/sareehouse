                        ...
                        <div class="card-body">
                           <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <input type="file" id="product_img" name="product_img" multiple="" class="form-control">
                                <span> <img src="../../image/product/<?php echo $product_img; ?>" width="100" height="100">  </span>
                              </div>
                              <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <textarea class="form-control" name="product_desc" id="product_desc" rows="9" cols="70"><?php echo $product_desc; ?></textarea>
                              </div>
