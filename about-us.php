                    ...
                    <div class="about-details">
                        <div>
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam, culpa!
                                ...
                                amet nemo ullam odit atque adipisci, hic, aliquid animi fugiat praesentium quidem.
                                Perspiciatis, expedita!</p>
                            <button onclick="location.href = 'shop-left-sidebar.php';" type="button"
                    ...
                    <div class="leader-contain">
                        <div class="leader-image">
                            ...
                            <ul class="social-media">
                                ...
                                <li>
                                    <a href="www.twitter.php">
                                        <i class="fab fa-twitter"></i>
                                    </a>
                                </li>

                                <li>
                                    <a href="www.google.php">
        ...
        <div class="container">
            ...
            <div class="testimonial-slider product-wrapper slide-3-1 slick-lg-space">
                <div>
                    <div class="testimonial-contain">
                        ...
                        <div class="testimonial-details">
                            ...
                            <h5 class="details-images"><i class="fas fa-quote-left"></i>Lorem ipsum dolor sit amet
                                consectetur adipisicing elit. Quidem cum consequatur sit cupiditate, quaerat sint porro
                                deserunt voluptas eligendi impedit.<i class="fas fa-quote-right"></i></h5>
                            <h5><strong>Johnkee</strong> / Apply.co</h5>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="testimonial-contain">
                        <div class="textimonial-image">
                            <img src="assets/images/inner-page/review-image/2.jpg" class="img-fluid" alt="">
                        </div>
                ...
                <div>
                    <div class="testimonial-contain">
                        <div class="textimonial-image">
                            <img src="assets/images/inner-page/review-image/3.jpg" class="img-fluid" alt="">
                        </div>
                ...
                <div>
                    <div class="testimonial-contain">
                        <div class="textimonial-image">
                            <img src="assets/images/inner-page/review-image/4.jpg" class="img-fluid" alt="">
                        </div>
                ...
                <div>
                    <div class="testimonial-contain">
                        <div class="textimonial-image">
                            <img src="assets/images/inner-page/review-image/5.jpg" class="img-fluid" alt="">
                        </div>
